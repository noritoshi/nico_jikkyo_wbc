...
このページの上部にある緑色の「**Code**」ボタンをクリックし、「**Download ZIP**」を選択してダウンロードします。

ダウンロードした ZIP ファイルをダブルクリックして解凍してください。`nico_jikkyo_wbc-main` というフォルダができます。
...
4. 先ほど解凍した `nico_jikkyo_wbc-main` フォルダを選択して「選択」をクリック
